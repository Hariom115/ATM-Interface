...
public class ATMInterface extends JFrame {
    ...
    private JLabel title, balanceLabel, label, labelname, labeltask, labelpswd;
    ...
    public ATMInterface() {
        ...
        labeltask = new JLabel("Task-2 ||");
        labeltask.setBounds(0,0,50,0);
        labeltask.setFont(new Font("Tahoma", Font.PLAIN, 10));
        labeltask.setForeground(Color.WHITE);

        labelname = new JLabel("By Hariom Vishwakarma ||");
        labelname.setBounds(0,10,200,0);
        labelname.setFont(new Font("Tahoma", Font.PLAIN, 10));
        labelname.setForeground(Color.WHITE);

        labelpswd = new JLabel("PIN : 2223");
        labelpswd.setBounds(0,20,50,0);
        labelpswd.setFont(new Font("Tahoma", Font.PLAIN, 10));
